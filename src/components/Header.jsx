...
const Header = () => {
  ...
  return (
    <div className="text-white w-full flex bg-[#1A0C25] 2xl:h-[4vw] md:h-[6vw] font-montserrat fixed top-0 z-10 transition-transform duration-300 translate-y-0 backdrop-blur-md bg-opacity-60">
      <div className="align-center navbar text-center w-full flex justify-between items-center px-14 py-3">
      ...
      {menuOpen && (
        ...
        >
          {/* Dropdown Toggle */}
          <button onClick={toggleDropdown} className="text-sm font-raleway text-[#F6E8FB]">
            Menu
          </button>
          ...
          {dropdownOpen && (
            <div className="flex flex-col items-center mt-2 gap-2">
              <Link to="/servicepage1" className="text-sm font-raleway text-[#F6E8FB] border-b border-[#952981]">Services</Link>
              <Link to="/aboutus" className="text-sm font-raleway text-[#F6E8FB] border-b border-[#952981]">About</Link>
              <Link to="/prices" className="text-sm font-raleway text-[#F6E8FB] border-b border-[#952981]">Prices</Link>
            </div>
          )}

                ...
                <ul className="space-y-2 flex flex-col justify-center items-center">
                  <li>
                    <Link
                      ...
                      className={`block p-3 border-b-2 border-[#952981] w-[18vw] hover:text-[#B740A1]  transition duration-200 ${activeLink === '/service1' ? 'text-[#B740A1]' : ''
                        }`}
                  ...
                  <li>
                    <Link
                      ...
                      className={`block p-3 border-b-2 border-[#952981] w-[18vw] hover:text-[#B740A1]  transition duration-200 ${activeLink === '/service2' ? 'text-[#B740A1]' : ''
                        }`}
                  ...
                  <li>
                    <Link
                      ...
                      className={`block p-3 border-b-2 border-[#952981] w-[18vw] hover:text-[#B740A1]  transition duration-200 ${activeLink === '/service3' ? 'text-[#B740A1]' : ''
                        }`}
                  ...
                  <li>
                    <Link
                      ...
                      className={`block p-3 border-b-2 border-[#952981] w-[18vw] hover:text-[#B740A1]  transition duration-200 ${activeLink === '/service4' ? 'text-[#B740A1]' : ''
                        }`}

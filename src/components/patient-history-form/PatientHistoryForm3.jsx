      ...
      <div style={styles.sidebar}>
        ...
        <div style={styles.sidebarContent}>
          ...
          <div style={styles.progress}>
            <span style={styles.progressStep}>1</span> →<span style={styles.progressStep}>2</span> →
              ...
              <tr key={index}>
                ...
                <td style={styles.tableCell}>
                  <input
                    ...
                    value="yes"
                    style={styles.radio}
                    onChange={() => handleOptionChange(`question${index}`, true)}
                  />
                </td>
                <td style={styles.tableCell}>
                  <input
                    ...
                    value="no"
                    style={styles.radio}
                    onChange={() => handleOptionChange(`question${index}`, false)}
                  />
                </td>
              </tr>
            ))}
...
//           </p>
//           <p style={styles.sidebarDetails}>
//             This information is critical for our AI-powered tool, Aignosis, to generate

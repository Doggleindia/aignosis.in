        ...
        <div style={styles.sidebar}>
          ...
          <div style={styles.sidebarContent}>
            ...
            <p style={styles.sidebarDescription}>
              ISAA is an objective assessment tool for persons with autism which uses observation, clinical evaluation
              of behaviour, testing by interaction with the subject and also information supplemented by parents or
              caretakers in order to diagnose autism.
            </p>
            <p style={styles.sidebarDetails}>
              Directions: Below are given 40 statements which are divided under six domains, please select the

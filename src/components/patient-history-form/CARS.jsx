        ...
        <center>
          ...
          <div style={styles.sidebarContent}>
            ...
            <p style={styles.sidebarDescription}>
              The Childhood Autism Rating Scale, Second Edition (CARS II) is a diagnostic tool used to identify and
              assess the severity of autism spectrum disorder (ASD) in children.
            </p>
            <p style={styles.sidebarDetails}>
              It evaluates behaviors across areas like social interaction, communication, emotional responses, and
              sensory sensitivities. Combining direct observation with input from parents or caregivers, it provides a

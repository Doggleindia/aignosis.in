        ...
        <div style={styles.sidebar}>
          ...
          <div style={styles.sidebarContent}>
            ...
            <p style={styles.sidebarDescription}>
              A structured diagnostic tool designed to assess autism spectrum disorder (ASD) in children aged 2-9 years,
              focusing on social interaction, communication, restricted interests, and repetitive behaviors through
              caregiver responses and clinical observations.
            </p>
            <p style={styles.sidebarDetails}>
              It incorporates caregiver input, clinician observations, and context-specific questions to identify
              symptoms and support diagnostic accuracy. This tool is designed to be culturally adaptable,
              age-appropriate, and effective in differentiating autism-related behaviors from typical developmental
              variations.
            </p>
          </div>
        </div>
                    ...
                    <tr key={questionIndex}>
                      ...
                      <td style={styles.checkboxCell}>
                        <input
                          ...
                          onChange={(e) =>
                            handleResponseChange(section.subsection, questionIndex, 'observation', e.target.checked)
                          }
                        />
                      </td>
                      <td style={styles.radioCell}>
                        <input
                          ...
                          style={styles.radio}
                          onChange={(e) =>
                            handleResponseChange(section.subsection, questionIndex, 'answer', e.target.value)
                          }
                        />
                      </td>
                      <td style={styles.radioCell}>
                ...
                <tr key={index}>
                  ...
                  <td style={styles.radioCell}>
                    <input
                      ...
                      name={`sectionB-${index}`}
                      value="yes"
                      onChange={(e) => handleResponseChange('SectionB', index, 'answer', e.target.value)}
                    />
                  </td>
                  <td style={styles.radioCell}>
                    <input

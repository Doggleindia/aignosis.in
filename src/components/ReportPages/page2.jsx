    ...
    <div style={styles.container}>
      ...
      <div style={styles.meterContainer}>
        ...
        <div style={styles.legend}>
          <span style={{ ...styles.legendItem, backgroundColor: '#ff4d4d' }}>0-40 : Low</span>
          <span style={{ ...styles.legendItem, backgroundColor: '#f5deb3', marginLeft: '20px', marginRight: '20px' }}>
            40-60 : Mid
          </span>
          <span style={{ ...styles.legendItem, backgroundColor: '#4caf50' }}>60-100 : High</span>
        </div>
      </div>
      ...
      <div style={styles.textContainer}>
        ...
        <div style={styles.overviewBox}>
          ...
          <p style={styles.overviewText}>
            32 out of 100, which implies that your child shows traits of Neurodiversity. The entire purpose of this
            screening is to detect the possibility of social and communication issues that the child might be facing.
          </p>
          <p style={styles.overviewText}>

...
const PartnershipPage = () => {
  ...
  return (
    <>
     <ToastContainer />
    <div className="min-h-screen 2xl:px-[8rem] md:px-[4rem] mt-14 text-white flex flex-wrap flex-col w-full  max-sm:p-[2vw] font-montserrat bg-[#1A0C25] ">
      <div className="w-full flex 2xl:px-[2rem] py-[3rem] flex-col justify-center flex-wrap items-center border-t rounded-[10rem]  max-sm:rounded-[5rem] border-[#B874B580] md:mb-10 ">

...
const PrivacyPolicy = () => {
  ...
  This privacy policy (the "Privacy Policy") applies to your use of the website of Aignosis hosted at <a href="https://aignosis.in" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">aignosis.in</a>, the Services (as defined under the Aignosis "Terms of Use") and Aignosis applications on mobile platforms (Android, Blackberry, Windows Phone, iOS, etc.) (collectively ("AIGNOSIS" or "WEBSITE")), but does not apply to any third-party websites that may be linked to them, or any relationships you may have with the businesses listed on Aignosis.<br /><br />

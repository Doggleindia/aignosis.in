                    ...
                    <div className="w-full md:w-[50%] h-auto 2xl:pb-[0vw] md:pb-[15vw] p-[3vw]">
                        <div className="w-[100%] text-right flex-col mt-[3vw] h-auto flex font-raleway">
                            <div>
                                ...
                                <h1 className='mt-6 2xl:text-base md:text-sm text-xs text-left mr-[1vw]'>Occupational therapy helps children develop essential skills to handle daily tasks through motor skill development, balance, and sensory management, addressing hyperactivity and coordination challenges.</h1>
                            </div>
                            <div className='mt-6'>
                            ...
                            <div className='mt-6'>
                                <h1 className='2xl:text-2xl md:text-xl text-lg text-left font-medium'>Our therapy activities:
                                </h1>

              ...
              <div className="w-[100%] text-right flex-col mt-[3vw] h-auto flex font-raleway">
                <div>
                  ...
                  <h2 className="mt-6 2xl:text-base md:text-sm text-xs text-left mr-[1vw]">
                    Occupational therapy helps children develop essential skills
                    to handle daily tasks through motor skill development,
                    balance, and sensory management, addressing hyperactivity

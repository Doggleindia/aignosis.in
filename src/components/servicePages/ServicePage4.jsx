    ...
    const faqData = [
        {
            ...
            answer: "If your child shows signs of frequent emotional distress, difficulty with concentration, anger, or struggles in social interactions, behavior therapy may help address these challenges.",
        },
        {
            question: "At what age can my child begin therapy?",
            answer: "Children as young as 3 can benefit from behavior therapy, but it’s effective for any age group when emotional and social skills need support.",
        },
        {
            question: "How soon will I see progress?",
            answer: "Results vary by child, but consistent practice between sessions often leads to noticeable improvements within a few weeks.",
        },
        {
                ...
                <div className="w-full min-h-screen max-sm:h-auto px-[10vw] gap-[3vw] bg-[#1A0C25] font-montserrat text-white  flex justify-center items-start flex-wrap md:flex-nowrap">
                    <div className="w-full md:w-[50%] h-auto p-[3vw]">
                        <div className="w-[100%] text-right flex-col mt-[3vw] h-auto flex font-raleway">
                            <div>
                                <h2 className='2xl:text-2xl md:text-xl text-lg text-left font-semibold'>What is Occupational Therapy?</h2>
                                <h2 className='mt-6 2xl:text-base md:text-sm text-xs text-left mr-[1vw]'>Occupational therapy helps children develop essential skills to handle daily tasks through motor skill development, balance, and sensory management, addressing hyperactivity and coordination challenges.</h2>
                            </div>
                            <div className='mt-6'>
                            ...
                            <div className='mt-6'>
                                <h2 className='2xl:text-2xl md:text-xl text-lg text-left font-medium'>Our therapy activities:
                                </h2>

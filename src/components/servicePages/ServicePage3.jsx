  ...
  return (
    <>
      ...
      <SEO
        ...
        metaDescription={
          "Learn about early intervention, occupational therapy, and signs of autism in toddlers. Explore behavior therapy solutions at Aignosis for autism care."
        }
          ...
          <div className="w-full min-h-screen max-sm:h-auto px-[10vw] gap-[3vw] bg-[#1A0C25] font-montserrat text-white  flex justify-center items-start flex-wrap md:flex-nowrap">
            <div className="w-full md:w-[50%] h-auto p-[3vw]">
              <div className="w-[100%] text-right flex-col mt-[3vw] h-auto flex font-raleway">
                <div>
                  ...
                  <h2 className="mt-6 2xl:text-base md:text-sm text-xs text-left mr-[1vw]">
                    Behavior therapy helps children manage emotions and address
                    challenges like attention issues, anger, anxiety,
                    stubbornness, and socialization difficulties.
                  </h2>
                </div>
                <div className="mt-6">
                  <h2 className="2xl:text-2xl md:text-xl text-lg text-left font-semibold">
              ...
              <div className="w-[100%] flex-col mt-[4vw] h-[auto] py-[2vw] rounded-3xl bg-[#564A5952] px-[2vw] border border-[#B7407D80]">
                ...
                <h2 className=" mt-3 pl-[1vw] 2xl:text-base md:text-sm text-xs text-center">
              ...
              <div className="w-[100%] mt-[4vw] flex-col h-[35vw] justify-center max-sm:hidden  md:flex items-center">
                <div className="flex justify-center gap-5 items-center">
                  ...
                  ></span>
                  <h2 className="text-[#F1C6FE] 2xl:text-base md:text-sm">
                    Advantages
                  </h2>
                  <span
                    className="h-[10px] w-[118px] rounded-full max-sm:w-[60px]"
                ...
                <div className=" justify-center w-full items-center flex flex-col">
                  <h2 className="mt-5 2xl:text-5xl md:text-3xl font-medium">
                    Why choose us
                  </h2>
                  <h2 className="mt-3 2xl:text-base md:text-sm">
                    Early Intervention + Consistent Practice{" "}
                  </h2>
                  <h2 className="font-semibold italic 2xl:text-xl md:text-lg text-[#9C00AD]">
                    {" "}
                    = Enhanced Progress!
                  </h2>
                </div>
                ...
                <div className=" hidden w-full pt-[3vw] pl-[2.5vw] h-[25vw]  justify-center items-center">
                  <div className="w-full flex h-[22vw] relative">
                    ...
                    <div className="group ">
                      ...
                      <h2 className="text-black absolute text-[10px] font-medium left-[9vw] -top-[2vw] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <div className="group ">
                      ...
                      <img
                        ...
                        loading="lazy"
                      />
                      <h2 className="text-black absolute text-[10px] font-medium left-[22vw] -top-[1vw] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <div className="group ">
                      ...
                      <img
                        ...
                        loading="lazy"
                      />
                      <h2 className="text-black z-20 absolute text-[10px] font-medium left-[8.6vw] top-[7.5vw] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <div className="group ">
                      ...
                      <img
                        ...
                        loading="lazy"
                      />
                      <h2 className="text-black absolute z-20 text-[10px] font-medium left-[21vw] top-[9vw] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <div className="w-[50%]  max-sm:w-full  sm:block h-auto p-[3vw] md:sticky max-sm:mr-[3vw]  max-sm:mt-[5vw] md:top-10">
              <div className="max-sm:w-[80vw] w-auto relative md:z-10 flex-col h-[auto] py-[2vw] rounded-3xl bg-[#564A5957] flex items-center justify-center">
                ...
                <h2 className="2xl:text-xl md:text-lg mt-10 font-semibold font-manrope ">
                  Book an online consultation{" "}
                </h2>
                <h2 className="2xl:text-xl md:text-lg font-semibold font-manrope">
                  Today
                </h2>

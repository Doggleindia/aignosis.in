  ...
  return (
    <>
      ...
      <SEO
        ...
        metaDescription={
          'Explore AI-based autism diagnosis, detection tech, and educational support for children with autism. Aignosis provides specialized solutions to enhance learning.'
        }
      />
        ...
        <div className="h-full w-full">
          <div className="flex h-auto w-full items-center justify-center bg-[#1A0C25] px-4 sm:px-0">
            <div className="2xl:mt-[6vw] relative z-10 flex h-auto w-full flex-col items-center justify-center md:mt-[12vh]">
              ...
              {/* Image Section */}
              <div className="mb-20 mt-[2vw] h-[200px] w-[80%] overflow-hidden rounded-lg bg-[#D9D9D9] max-sm:mb-4 sm:mb-[50px] sm:h-[20vw] sm:w-[40vw]">
                <img src={service5} alt="" className="h-full w-full object-cover" loading="lazy" />
              </div>
              {/* CTA and Rating */}
            ...
            <div className="h-auto w-full p-[3vw] md:w-[50%]">
              <div className="mt-[3vw] flex h-auto w-[100%] flex-col text-right font-raleway">
                <div>
                  ...
                  <h2 className="2xl:text-base mr-[1vw] mt-6 text-left text-xs md:text-sm">
                    Special education offers personalized learning strategies to support your child’s unique educational
                    needs, helping them overcome academic challenges and develop essential life skills.
                  </h2>
                </div>
                <div className="mt-6">
                  <h2 className="2xl:text-2xl text-left text-lg font-semibold md:text-xl">
                ...
                <div className="mt-6">
                  <h2 className="2xl:text-2xl text-left text-lg font-medium md:text-xl">
                    Sample Activities in Special Education:
                  </h2>
              ...
              <div className="mt-[4vw] h-[35vw] w-[100%] flex-col items-center justify-center max-sm:hidden md:flex">
                ...
                <div className="flex w-full flex-col items-center justify-center">
                  ...
                  <h2 className="2xl:text-xl font-semibold italic text-[#9C00AD] md:text-lg"> = Effective Progress!</h2>
                </div>

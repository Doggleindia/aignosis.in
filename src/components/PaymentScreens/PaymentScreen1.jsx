...
const PaymentScreen1 = ({ onNext, onBack }) => {
  ...
  return (
    <div className="w-full px-[5vw] text-white font-montserrat min-h-screen bg-[#1A0C25] max-sm:px-[3vw] max-sm:pt-[5vw]">
      ...
      <div className="navsection pt-[6vw] max-sm:mt-[33px] w-full h-[15vw] px-[5vw] gap-[15vw] flex justify-center items-center py-[1vw] max-sm:gap-[5vw] max-sm:flex-row  ">
        ...
        <span className="text-[#B7407DB2] flex align-center text-4xl max-sm:text-2xl">→</span>
        <div className='flex flex-col justify-center items-center'>
        ...
        <span className="text-[#B7407DB2] text-4xl flex align-center max-sm:text-2xl">→</span>
        <div className='flex flex-col justify-center items-center'>
          <div className="w-[8vw] h-[8vw] relative text-[#B7407DB2] border border-[#B7407D80] flex justify-center items-center rounded-2xl max-sm:w-[15vw] max-sm:h-[15vw]">
      ...
      <div className="w-full mt-[5vw] min-h-[38vw] flex max-sm:flex-col justify-center gap-[5vw] max-sm:gap-[3vw]">
        ...
        <div className="right w-[60%] h-full max-sm:mb-[20px] bg-[#564A5957] rounded-2xl p-[5vw] max-sm:w-full max-sm:p-[4vw]">

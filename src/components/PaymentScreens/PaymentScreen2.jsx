      ...
      <div style={{ display: 'flex', justifyContent: 'space-around', marginTop: '30px' }}>
        ...
        <div style={{ width: '45%', backgroundColor: '#564A5957', padding: '40px', borderRadius: '10px', height: "auto" }}>
          ...
          <form>
            ...
            <div style={{ backgroundColor: '#564A5957', color: '#E2D6F9', padding: '20px', borderRadius: '10px', textAlign: 'center', marginTop: '30px'}}>
              <p>Transfer ₹164.23 to:</p>
              <div style={{ border: '1px solid #F6E8FB', borderRadius: '10px', padding: '10px', display: 'inline-block', marginTop: '10px', borderColor:'#9C00AD', width: '250px' }}>
              ...
              <p style={{ fontSize: '14px', color: '#FF6F61', marginTop: '10px' }}>Expires in <span style={{ fontWeight: 'bold' }}>10:00</span> minutes</p>
            </div>

            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '20px' }}>
              <button onClick={handleNext} style={{ padding: '10px 20px', backgroundColor: '#1A0C25', color: '#F6E8FB', border: 'none', borderRadius: '5px', borderColor: "#9C00AD", marginTop: "40px", marginLeft: "300px" }}>Next</button>
            </div>
          </form>
        </div>
      </div>

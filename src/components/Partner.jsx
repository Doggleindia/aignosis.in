...
const Partner = () => {
  return (
    <div className="mb-[2vw] flex min-h-[30vw] max-w-full flex-col items-center justify-center overflow-hidden bg-white px-6 py-10 text-center text-white">
      <div className="flex h-[2vw] w-full items-center justify-center">
        <h1 className="font-montserrat text-4xl font-semibold text-black max-sm:text-2xl">Supported by</h1>
      </div>

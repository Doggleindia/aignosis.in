    ...
    <div className='bg-[#1A0C25] relative w-full p-[5vw] '>
      ...
      <div className='flex flex-col'>
        <div className='flex justify-center items-center' >
          ...
          <h4 className='text-[#F6E8FB] font-raleway mt-4 md:mt-[2vw] text-center text-[48px] leading-7 md:leading-[1.2vw] max-sm:text-[24px] md:mr-[20px]'>Supported by Leaders in Innovation and Care</h4>
        </div>

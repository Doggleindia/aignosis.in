...
//   return (
//     <Protectedpage>
//       <div className="bg-[#1A0C25] flex flex-col justify-center items-center h-[100vh] ">
//         {!isBackInfoVisible ? (
...
//               style={{ color: 'white' }}
//             />
//             <div className="text-white">I consent to give my data for the betterment of humanity</div>
//           </div>
//         </div>
//       </div>

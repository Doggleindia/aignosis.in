...
const WebcamMicTest = () => {
  ...
  return (
   ...
   {!isCalVisible?( <div className='bg-[#1A0C25] min-h-screen flex flex-col justify-center items-center'> 
      <div className="w-[900px] h-[600px] max-sm:w-[90vw] mt-[6px] bg-[#FDF9FF] rounded-3xl shadow-lg flex flex-col items-center p-8 space-y-6 relative border border-[#5F1B73]">
        {/* Ai.gnosis Branding */}
        ...
        <div className="w-[500px] max-sm:w-auto h-[300px] bg-[#D9D9D9] rounded-lg flex items-center justify-center overflow-hidden">
          {snapshotTaken ? (

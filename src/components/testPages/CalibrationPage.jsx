        ...
        <div className="bg-[#1A0C25] min-h-screen flex flex-col justify-center items-center p-4">
          <div className="w-full max-w-[950px] bg-[#FDF9FF] rounded-3xl flex flex-col items-center p-8 space-y-6 shadow-lg">
            ...
            <p className="text-center text-[#292738] font-raleway font-normal">
              Please complete the task in sequence before proceeding to the next
              step.
            </p>

            <div className="text-left text-[#292738] font-raleway font-medium space-y-2 w-full max-w-[500px]">
              <p>
                1. Click each dog face one at a time as it appears on the
                screen, ensuring your child is looking at it before you click.
              </p>
              <p>
                2. Ensure your child watches the entire video without pausing or
                replaying it.
              </p>
              <p>
                3. When prompted in the video, call out for your child as
                instructed.
              </p>
            </div>

            <div className="w-full max-w-[400px]">
              <label className="text-[#292738] font-medium font-raleway block mb-2">
                Select Video Calibration Language:
              </label>
              <select
                value={selectedLanguage}

      ...
      {steps.map((step, index) => (
        ...
        >
          ...
          <div className="flex flex-col items-center space-y-2">
            <div 
              className="w-16 h-16 bg-[#D9D9D9] hover:bg-[#B7407D] cursor-pointer hover:scale-105 transition-all duration-300 ease-in-out rounded-lg flex items-center justify-center shadow-md"
            >

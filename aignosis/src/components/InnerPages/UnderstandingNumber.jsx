...
const UnderstandingNumber = ({ bg }) => {
  ...
  return (
    <>
      <div
        ref={containerRef}
        className='w-[60%] h-[20vw] flex flex-col border border-[#B874B540] overflow-hidden snap-y snap-mandatory rounded-3xl mb-10 relative  max-sm:w-[390px] max-sm:h-auto'
      ...
      >
        ...
        {/* First Card */}
      {!showSecondCard&& <div className="firstCard snap-start flex relative z-10">
          <div className="w-[50%]  ml-[5rem] max-sm:ml-4 sm:mt-[20px] text-4xl max-sm:text-lg h-full flex flex-col  justify-center items-start ">
            ...
            <div className='w-[10rem] max-sm:w-[7rem] cursor-pointer group hover:bg-[#B740A1] transition-colors duration-300 mt-[2rem] max-sm:mt-4  max-sm:mb-4 border-2 border-[#B740A1] gap-4 rounded-full flex justify-center items-center text-[#0D0C0A] h-[3rem] max-sm:h-[30px] bg-transparent'>
              <a href="" className='text-white text-base'>Learn more</a>
            </div>
          </div>
          <div className="w-[50%] h-full flex justify-center items-center max-sm:mt-8">
        ...
        {/* Second Card */}
        <div
          className={`absolute inset-0 w-auto h-auto flex rounded-3xl transition-all duration-700 ease-in-out ${
        ...
        >
          ...
          <div className="secondCard flex">
            <div className="w-[50%] ml-[5rem] max-sm:ml-4  text-4xl h-full flex flex-col justify-center items-start max-sm:text-lg">
              <h1 className='font-medium text-[#F6E8FB]'>

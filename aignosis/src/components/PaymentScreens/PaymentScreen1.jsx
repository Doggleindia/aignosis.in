...
const PaymentScreen1 = ({ onNext }) => {
  ...
  return (
    <div style={{ backgroundColor: '#1A0C25', color: '#e2d6f9', fontFamily: 'Raleway, sans-serif', padding: '40px', minHeight: '100vh' }}>
      {/* Steps Section */}
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '150px' }}>
        <div style={{ textAlign: 'center', margin: '0 40px' }}>
          <div style={{ fontSize: '48px', color: '#ff79c6', fontFamily: 'Manrope, sans-serif' }}>1</div>
        ...
        <div style={{ textAlign: 'center', margin: '0 40px' }}>
          <div style={{ fontSize: '48px', color: '#ff79c6', fontFamily: 'Manrope, sans-serif' }}>2</div>
          <FaCreditCard style={{ fontSize: '24px', color: '#ff79c6' }} />
          <div style={{ fontSize: '12px' }}>Payment details</div>
        </div>
        <div style={{ fontSize: '24px', color: '#ff79c6', margin: '0 20px' }}>→</div>
        <div style={{ textAlign: 'center', margin: '0 40px' }}>
          <div style={{ fontSize: '48px', color: '#ff79c6', fontFamily: 'Manrope, sans-serif' }}>3</div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-around', marginTop: '30px', flexWrap: 'wrap' }}>
        {/* Order Summary */}
        <div style={{ width: '100%', maxWidth: '300px', backgroundColor: '#1A0C25', padding: '20px', borderRadius: '10px', marginBottom: '20px' }}>
          <h1 style={{ color: '#ff79c6', fontFamily: 'Manrope, sans-serif', marginBottom: "30px" }}>Order Summary</h1>
        ...
        {/* Payment Methods */}
        <div style={{ width: '100%', maxWidth: '500px', backgroundColor: '#564A5957', padding: '40px', borderRadius: '10px', height: "auto" }}>
          <h1 style={{ color: '#F6E8FB', marginBottom: "30px", fontSize: "20px", fontFamily: 'Manrope, sans-serif' }}>Payment Methods</h1>
          <form>

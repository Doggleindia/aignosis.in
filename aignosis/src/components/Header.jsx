...
const Header = () => {
  return (
    <div>
        <div className="navbar text-white font-montserrat bg-[#1A0C25] text-center w-full h-[7rem] flex justify-between items-center px-[12rem]">
                ...
                <div className='flex justify-center font-medium items-center gap-[8rem]'>
                    ...
                    <Link to="/appointment" className='w-[15rem] gap-4 rounded-full flex justify-center cursor-pointer items-center text-[#0D0C0A] h-[3.5rem] bg-white group hover:bg-[#B7407D] hover:text-white transition-colors duration-300'>
